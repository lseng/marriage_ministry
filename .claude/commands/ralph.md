...
```
/ralph task "Add validation to login form"
```
...
6. **Validate** - Run lint, build, tests (backpressure)
...
├── loop_iso.sh            # Isolated loop with worktrees
...
### Execute single task
```
/ralph task "Fix login form validation bug"
```
